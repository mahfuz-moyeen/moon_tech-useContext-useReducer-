...
const ProductCard = ({ product, forCart, forWishlist }) => {
      ...
      <div className='flex gap-2 mt-5'>
        ...
        {forWishlist ?
          <button
            ...
            onClick={() =>
              dispatch({ type: actionTypes.REMOVE_WISHLIST, payload: product })
            }
          >
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: actionTypes.ADD_WISHLIST, payload: product })
            }
          >
